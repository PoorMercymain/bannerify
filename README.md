...
## Как запустить
Создаем .env файл (или переименовываем .env.example в .env) в корне проекта, прописываем docker-compose up или make up. При конфигурации из .env.example сервис будет доступен на `localhost:8080`
